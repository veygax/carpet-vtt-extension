...
public class ExampleOwnSettings
{
    ...
    @Rule(desc = "Example integer setting", category = "carpet-vtt-extension")
    ...
    @Rule(desc = "Example bool setting", category = "carpet-vtt-extension")
